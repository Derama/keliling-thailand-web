...
export default function TestimonyContent() {
  ...
  return (
    <main className="min-h-[100dvh] bg-white pt-20">
      <section className="relative overflow-hidden bg-[#050505] pt-20 pb-16 sm:pt-24 sm:pb-18">
        <div className="absolute inset-x-0 top-0 h-1 bg-[#FFC531]" />
        <div className="absolute -left-12 top-24 h-40 w-40 rounded-full bg-[#FFC531]/12 blur-3xl" />
        <div className="absolute bottom-10 right-0 h-52 w-52 rounded-full bg-white/6 blur-3xl" />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <p className="text-xs font-bold uppercase tracking-[0.26em] text-[#FFC531]">
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:items-start">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/35 px-6 py-3 font-bold text-white transition-colors hover:border-[#FFC531] hover:text-[#FFC531]"
              >
      ...
      <section className="bg-[#FAE7B8] py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#FFC531]">
              Featured Reviews
            </p>
          ...
          <ScrollReveal stagger className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {featured.map((item, i) => (
              <div
                key={i}
                className="group flex flex-col overflow-hidden rounded-[2rem] border border-[#050505]/10 bg-white p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-[#FFC531]/50 hover:shadow-xl"
              >
                <div className="flex items-center justify-between">
                  <div className="flex gap-1.5 text-[#FFC531]">
                    {Array.from({ length: item.stars }).map((_, s) => (
                      <span key={s} className="text-lg">★</span>
                    ))}
                  </div>
                  <span className="rounded-full bg-[#050505]/8 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#050505]/58">
                    Review
                  </span>
                </div>
                ...
                <div className="mt-8 border-t border-[#050505]/8 pt-5">
                  <p className="font-extrabold text-[#050505]">{item.name}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal stagger className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {more.map((item, i) => (
              <div
                key={i}
                className="group flex flex-col overflow-hidden rounded-[1.7rem] border border-gray-100 bg-[#FAE7B8]/35 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#FFC531] hover:shadow-md"
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="rounded-full bg-white px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.14em] text-[#050505]">
                    {item.service}
                  </span>
                </div>
                ...
                <div className="mt-5 border-t border-[#050505]/8 pt-4">
                  <p className="text-sm font-extrabold text-[#050505]">{item.name}</p>
      ...
      <section className="relative overflow-hidden bg-[#050505] py-24">
        ...
        <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-[#FFC531] px-6 py-3 font-bold text-black transition-colors hover:bg-yellow-400"
            >
