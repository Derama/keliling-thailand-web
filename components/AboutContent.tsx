    ...
    <main className="min-h-[100dvh] bg-white">
      <section className="relative overflow-hidden bg-[#050505] pt-24 pb-20">
        ...
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#050505]/96 via-[#050505]/78 to-[#050505]/42" />
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#050505] to-transparent" />
        <div className="absolute -left-16 top-20 h-44 w-44 rounded-full bg-[#FFC531]/10 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-start gap-10 px-4 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8">
          <div className="animate-slide-up">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.3em] text-[#FFC531]">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/12 bg-white/7 p-5 shadow-2xl backdrop-blur-sm sm:p-8">
              <div className="mb-7 flex items-end justify-between gap-4 border-b border-white/10 pb-5">
                ...
                <div className="text-right">
                  ...
                  <p className="mt-1 text-3xl font-extrabold text-[#FFC531]">
                    2021
                  </p>
                </div>
              </div>
      ...
      <section className="bg-[#FAE7B8] py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <ScrollReveal>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#FFC531]">
                {about.story.eyebrow}
              </p>
              <h2 className="mt-4 max-w-sm text-4xl font-extrabold leading-tight text-[#050505] sm:text-5xl">
                {about.story.title}
              </h2>
              <div className="mt-10 space-y-4">
                {about.values.items.slice(0, 3).map((item, index) => (
                  <div
                    key={item.title}
                    className="flex items-center gap-4 rounded-[1.4rem] border border-[#050505]/8 bg-white p-4 transition-all hover:border-[#FFC531]/30 hover:shadow-md"
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#050505] text-sm font-bold text-[#FFC531]">
                      {String(index + 1).padStart(2, "0")}
                    </div>
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#050505]/40">
                        {item.icon}
                      </p>
                      <p className="mt-0.5 text-base font-bold text-[#050505]">
                        {item.title}
                      </p>
                    </div>
                  </div>
            ...
            <ScrollReveal className="relative">
              ...
              <div className="relative rounded-[2rem] border border-[#050505]/10 bg-white p-8 shadow-[0_24px_70px_rgba(16,32,60,0.12)] sm:p-12">
                <p className="text-2xl font-bold leading-snug text-[#050505] sm:text-3xl">
                  {about.header.subtitle}
                </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal stagger className="grid gap-6 md:grid-cols-2">
            {about.values.items.map((item, index) => (
              <div
                key={item.title}
                className="group relative rounded-[2rem] border border-white/8 bg-white/[0.04] p-8 transition-all hover:border-[#FFC531]/30 hover:bg-white/[0.06] sm:p-10"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="text-5xl transition-transform group-hover:scale-110">{item.icon}</div>
                  <div className="text-sm font-bold uppercase tracking-[0.28em] text-[#FFC531]/30">
                    {String(index + 1).padStart(2, "0")}
                  </div>
                </div>
      ...
      <section className="relative overflow-hidden bg-white py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="relative overflow-hidden rounded-[2.5rem] bg-[#050505] px-6 py-12 text-center shadow-[0_30px_90px_rgba(16,32,60,0.22)] sm:px-16 sm:py-20">
              <div className="absolute -left-20 -top-20 h-64 w-64 rounded-full bg-[#FFC531]/10 blur-3xl" />
              <div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-[#FFC531]/10 blur-3xl" />
              
              <div className="relative z-10 mx-auto max-w-3xl">
                <p className="mb-6 text-xs font-bold uppercase tracking-[0.3em] text-[#FFC531]">
                  {about.header.eyebrow}
                </p>
                <h2 className="text-4xl font-extrabold text-white sm:text-5xl">
                  {about.cta.title}
