...
export const cities: City[] = [
  {
    ...
    attractions: [
      ...
      { id: "jim-thompson-house", hours: 1.5, image: "/places/bangkok/jim-thompson-house.jpg" },
      { id: "wat-saket", hours: 1, image: "/places/bangkok/wat-saket.jpg" },
      { id: "erawan-shrine", hours: 0.5, image: "/places/bangkok/erawan-shrine.jpg" },
      { id: "khaosan-road", hours: 1.5, image: "/places/bangkok/khaosan-road.jpg" },
      { id: "lumpini-park", hours: 1, image: "/places/bangkok/lumpini-park.jpg" },
      { id: "wat-benchamabophit", hours: 1, image: "/places/bangkok/wat-benchamabophit.jpg" },
      { id: "safari-world", hours: 4, image: "/places/bangkok/safari-world.jpg" },
      { id: "siam-paragon", hours: 2, image: "/places/bangkok/siam-paragon.jpg" },
    ],
  },
  {
    id: "pattaya",
    ...
    attractions: [
      ...
      { id: "jomtien-beach", hours: 2, image: "/places/pattaya/jomtien-beach.jpg" },
      { id: "ramayana-water-park", hours: 4, image: "/places/pattaya/ramayana-water-park.jpg" },
      { id: "cartoon-network-amazone", hours: 4, image: "/places/pattaya/cartoon-network-amazone.jpg" },
      { id: "mini-siam", hours: 1.5, image: "/places/pattaya/mini-siam.jpg" },
    ],
  },
  {
    id: "ayutthaya",
    ...
    attractions: [
      ...
      { id: "ayutthaya-historical-park", hours: 3, image: "/places/ayutthaya/ayutthaya-historical-park.jpg" },
      { id: "wat-yai-chai-mongkhon", hours: 1, image: "/places/ayutthaya/wat-yai-chai-mongkhon.jpg" },
      { id: "wat-phanan-choeng", hours: 1, image: "/places/ayutthaya/wat-phanan-choeng.jpg" },
      { id: "chao-sam-phraya-museum", hours: 1.5, image: "/places/ayutthaya/chao-sam-phraya-museum.jpg" },
    ],
  },
  {
    id: "kanchanaburi",
    ...
    attractions: [
      ...
      { id: "war-cemetery", hours: 1, image: "/places/kanchanaburi/war-cemetery.jpg" },
      { id: "sai-yok-national-park", hours: 3, image: "/places/kanchanaburi/sai-yok-national-park.jpg" },
      { id: "mon-bridge", hours: 1, image: "/places/kanchanaburi/mon-bridge.jpg" },
    ],
  },
  {
    id: "huahin",
    ...
    attractions: [
      ...
      { id: "phraya-nakhon-cave", hours: 3, image: "/places/huahin/phraya-nakhon-cave.jpg" },
      { id: "mrigadayavan-palace", hours: 1.5, image: "/places/huahin/mrigadayavan-palace.jpg" },
      { id: "khao-sam-roi-yot", hours: 4, image: "/places/huahin/khao-sam-roi-yot.jpg" },
    ],
  },
  {
    id: "khaoyai",
    ...
    attractions: [
      ...
      { id: "muak-lek-waterfall", hours: 1.5, image: "/places/khaoyai/muak-lek-waterfall.jpg" },
    ],
  },
];
